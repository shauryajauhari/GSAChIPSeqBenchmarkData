...
install.packages("devtools", dependencies = TRUE, repos = "https://mirrors.tuna.tsinghua.edu.cn/CRAN/")
install.packages("roxygen2", dependencies = TRUE, repos = "https://mirrors.tuna.tsinghua.edu.cn/CRAN/")
library(devtools)
library(roxygen2)
...
setwd("~/Desktop/DeleteMe/GSAChIPSeqBenchmarkData")
proj_set()
